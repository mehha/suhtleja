...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  await db.run(sql`CREATE TABLE \`pages_blocks_hero_paws_ctas\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`label\` text,
  	...
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`pages_blocks_hero_paws\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_hero_paws_ctas_order_idx\` ON \`pages_blocks_hero_paws_ctas\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_hero_paws_ctas_parent_id_idx\` ON \`pages_blocks_hero_paws_ctas\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_hero_paws_cards_badges\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`label\` text,
  	\`icon\` text DEFAULT 'Stethoscope',
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`pages_blocks_hero_paws_cards\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_hero_paws_cards_badges_order_idx\` ON \`pages_blocks_hero_paws_cards_badges\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_hero_paws_cards_badges_parent_id_idx\` ON \`pages_blocks_hero_paws_cards_badges\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_hero_paws_cards\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`title\` text,
  	...
  	\`gradient_from\` text DEFAULT 'from-slate-100',
  	\`gradient_to\` text DEFAULT 'to-slate-200',
  	\`label_bg\` text DEFAULT 'bg-slate-800',
  	FOREIGN KEY (\`image_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`pages_blocks_hero_paws\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_hero_paws_cards_order_idx\` ON \`pages_blocks_hero_paws_cards\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_hero_paws_cards_parent_id_idx\` ON \`pages_blocks_hero_paws_cards\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_hero_paws_cards_image_idx\` ON \`pages_blocks_hero_paws_cards\` (\`image_id\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_hero_paws\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_hero_paws_order_idx\` ON \`pages_blocks_hero_paws\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_hero_paws_parent_id_idx\` ON \`pages_blocks_hero_paws\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_hero_paws_path_idx\` ON \`pages_blocks_hero_paws\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_aac_features_items\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	...
  	\`cta_label\` text,
  	\`cta_href\` text,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`pages_blocks_aac_features\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_aac_features_items_order_idx\` ON \`pages_blocks_aac_features_items\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_aac_features_items_parent_id_idx\` ON \`pages_blocks_aac_features_items\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_aac_features\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_aac_features_order_idx\` ON \`pages_blocks_aac_features\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_aac_features_parent_id_idx\` ON \`pages_blocks_aac_features\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_aac_features_path_idx\` ON \`pages_blocks_aac_features\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_usage_contexts_items\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`title\` text,
  	\`description\` text,
  	\`image_id\` integer,
  	\`button_label\` text DEFAULT 'Loe lähemalt',
  	\`button_href\` text,
  	FOREIGN KEY (\`image_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`pages_blocks_usage_contexts\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_usage_contexts_items_order_idx\` ON \`pages_blocks_usage_contexts_items\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_usage_contexts_items_parent_id_idx\` ON \`pages_blocks_usage_contexts_items\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_usage_contexts_items_image_idx\` ON \`pages_blocks_usage_contexts_items\` (\`image_id\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_usage_contexts\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_usage_contexts_order_idx\` ON \`pages_blocks_usage_contexts\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_usage_contexts_parent_id_idx\` ON \`pages_blocks_usage_contexts\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_usage_contexts_path_idx\` ON \`pages_blocks_usage_contexts\` (\`_path\`);`)
  ...
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_hero_paws_ctas\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`label\` text,
  	...
  	\`variant\` text DEFAULT 'primary',
  	\`_uuid\` text,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`_pages_v_blocks_hero_paws\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_hero_paws_ctas_order_idx\` ON \`_pages_v_blocks_hero_paws_ctas\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_hero_paws_ctas_parent_id_idx\` ON \`_pages_v_blocks_hero_paws_ctas\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_hero_paws_cards_badges\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`label\` text,
  	\`icon\` text DEFAULT 'Stethoscope',
  	\`_uuid\` text,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`_pages_v_blocks_hero_paws_cards\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_hero_paws_cards_badges_order_idx\` ON \`_pages_v_blocks_hero_paws_cards_badges\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_hero_paws_cards_badges_parent_id_idx\` ON \`_pages_v_blocks_hero_paws_cards_badges\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_hero_paws_cards\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`title\` text,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_hero_paws_cards_order_idx\` ON \`_pages_v_blocks_hero_paws_cards\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_hero_paws_cards_parent_id_idx\` ON \`_pages_v_blocks_hero_paws_cards\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_hero_paws_cards_image_idx\` ON \`_pages_v_blocks_hero_paws_cards\` (\`image_id\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_hero_paws\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_hero_paws_order_idx\` ON \`_pages_v_blocks_hero_paws\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_hero_paws_parent_id_idx\` ON \`_pages_v_blocks_hero_paws\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_hero_paws_path_idx\` ON \`_pages_v_blocks_hero_paws\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_aac_features_items\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`icon\` text DEFAULT 'message-circle',
  	...
  	\`cta_href\` text,
  	\`_uuid\` text,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`_pages_v_blocks_aac_features\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_aac_features_items_order_idx\` ON \`_pages_v_blocks_aac_features_items\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_aac_features_items_parent_id_idx\` ON \`_pages_v_blocks_aac_features_items\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_aac_features\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_aac_features_order_idx\` ON \`_pages_v_blocks_aac_features\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_aac_features_parent_id_idx\` ON \`_pages_v_blocks_aac_features\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_aac_features_path_idx\` ON \`_pages_v_blocks_aac_features\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_usage_contexts_items\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`title\` text,
  	...
  	\`_uuid\` text,
  	FOREIGN KEY (\`image_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`_pages_v_blocks_usage_contexts\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_usage_contexts_items_order_idx\` ON \`_pages_v_blocks_usage_contexts_items\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_usage_contexts_items_parent_id_idx\` ON \`_pages_v_blocks_usage_contexts_items\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_usage_contexts_items_image_idx\` ON \`_pages_v_blocks_usage_contexts_items\` (\`image_id\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_usage_contexts\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_usage_contexts_order_idx\` ON \`_pages_v_blocks_usage_contexts\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_usage_contexts_parent_id_idx\` ON \`_pages_v_blocks_usage_contexts\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_usage_contexts_path_idx\` ON \`_pages_v_blocks_usage_contexts\` (\`_path\`);`)
  ...
  await db.run(sql`CREATE TABLE \`users\` (
  	...
  	\`pin_updated_at\` text,
  	\`last_feeling\` text,
  	\`last_feeling_at\` text,
  	\`stripe_customer_id\` text,
  	\`stripe_subscription_id\` text,
  	\`membership_status\` text DEFAULT 'none',
  	\`trial_ends_at\` text,
  	\`current_period_ends_at\` text,
  	\`membership_cancel_at_period_end\` integer DEFAULT false,
  	\`updated_at\` text DEFAULT (strftime('%Y-%m-%dT%H:%M:%fZ', 'now')) NOT NULL,
  	\`created_at\` text DEFAULT (strftime('%Y-%m-%dT%H:%M:%fZ', 'now')) NOT NULL,
  	\`email\` text NOT NULL,
  ...
  await db.run(sql`CREATE TABLE \`boards_grid_cells\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`x\` numeric NOT NULL,
  	...
  	FOREIGN KEY (\`image_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	FOREIGN KEY (\`audio_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`boards\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`boards_grid_cells_order_idx\` ON \`boards_grid_cells\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`boards_grid_cells_parent_id_idx\` ON \`boards_grid_cells\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`boards_grid_cells_image_idx\` ON \`boards_grid_cells\` (\`image_id\`);`)
  await db.run(sql`CREATE INDEX \`boards_grid_cells_audio_idx\` ON \`boards_grid_cells\` (\`audio_id\`);`)
  await db.run(sql`CREATE TABLE \`boards_compounds_cells\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`cell_id\` text NOT NULL,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`boards_compounds\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`boards_compounds_cells_order_idx\` ON \`boards_compounds_cells\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`boards_compounds_cells_parent_id_idx\` ON \`boards_compounds_cells\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`boards_compounds_parts\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`boards_compounds_parts_order_idx\` ON \`boards_compounds_parts\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`boards_compounds_parts_parent_id_idx\` ON \`boards_compounds_parts\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`boards_compounds\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`boards\`(\`id\`) ON UPDATE no action ON DELETE cascade
  ...
  `)
  await db.run(sql`CREATE INDEX \`boards_compounds_order_idx\` ON \`boards_compounds\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`boards_compounds_parent_id_idx\` ON \`boards_compounds\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`boards\` (
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`name\` text NOT NULL,
  	...
  	\`action_bar_enabled\` integer DEFAULT true,
  	\`extra_ai\` integer DEFAULT false,
  	\`grid_cols\` numeric DEFAULT 12,
  	\`grid_rows\` numeric DEFAULT 8,
  	\`updated_at\` text DEFAULT (strftime('%Y-%m-%dT%H:%M:%fZ', 'now')) NOT NULL,
  	\`created_at\` text DEFAULT (strftime('%Y-%m-%dT%H:%M:%fZ', 'now')) NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`boards_owner_idx\` ON \`boards\` (\`owner_id\`);`)
  await db.run(sql`CREATE INDEX \`boards_thumbnail_idx\` ON \`boards\` (\`thumbnail_id\`);`)
  await db.run(sql`CREATE INDEX \`boards_updated_at_idx\` ON \`boards\` (\`updated_at\`);`)
  await db.run(sql`CREATE INDEX \`boards_created_at_idx\` ON \`boards\` (\`created_at\`);`)
  await db.run(sql`CREATE TABLE \`connect_dots_puzzles\` (
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`title\` text NOT NULL,
  ...
  await db.run(sql`CREATE TABLE \`payload_locked_documents_rels\` (
  	...
  	\`users_id\` integer,
  	\`boards_id\` integer,
  	\`connect_dots_puzzles_id\` integer,
  	...
  	FOREIGN KEY (\`categories_id\`) REFERENCES \`categories\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`users_id\`) REFERENCES \`users\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`boards_id\`) REFERENCES \`boards\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`connect_dots_puzzles_id\`) REFERENCES \`connect_dots_puzzles\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  ...
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_boards_id_idx\` ON \`payload_locked_documents_rels\` (\`boards_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_connect_dots_puzzles_id_idx\` ON \`payload_locked_documents_rels\` (\`connect_dots_puzzles_id\`);`)
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  await db.run(sql`DROP TABLE \`pages_blocks_hero_paws_ctas\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_hero_paws_cards_badges\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_hero_paws_cards\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_hero_paws\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_aac_features_items\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_aac_features\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_usage_contexts_items\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_usage_contexts\`;`)
  ...
  await db.run(sql`DROP TABLE \`_pages_v_blocks_hero_paws_ctas\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_hero_paws_cards_badges\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_hero_paws_cards\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_hero_paws\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_aac_features_items\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_aac_features\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_usage_contexts_items\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_usage_contexts\`;`)
  ...
  await db.run(sql`DROP TABLE \`boards_grid_cells\`;`)
  await db.run(sql`DROP TABLE \`boards_compounds_cells\`;`)
  await db.run(sql`DROP TABLE \`boards_compounds_parts\`;`)
  await db.run(sql`DROP TABLE \`boards_compounds\`;`)
  await db.run(sql`DROP TABLE \`boards\`;`)
